...
object Events {
  ...
  case class BatchCommitStarted(batchId: String, commitMessage: String,  parentId: Option[String] = None, eventContext: Option[EventContext] = None) extends SpecEvolutionEvent
