          ...
          assert(diff == Set(
            UnmatchedResponseBodyShape(
              ...
              UnmatchedShape(
                ...
                ShapeTrail("shape_8", Seq(ObjectFieldTrail("field_5", "shape_7")))
              )
            )
          ))
        }
        ...
        it("should group diffs") {
          ...
          val key2 = UnmatchedResponseBodyShape(
            ...
            UnmatchedShape(
              ...
              ShapeTrail("shape_8", Seq(ObjectFieldTrail("field_5", "shape_7"), ListItemTrail("shape_7", "shape_6"), ObjectFieldTrail("field_4", "shape_5")))
            )
          )
